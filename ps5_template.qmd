...
After exploring the webpage, we have realized:
 ...
 4- The 'category' data are located inside 'li' tagas with attribute: 'class_ = "display-inline-block usa-tag text-no-lowercase text-base-darkest bg-base-lightest margin-right-1"'.
